            ...
            <Col lg={9}>
                ...
                <Col md={6}>
                    ...
                    <Card.Body>
                        ...
                        Site React déployé sur serveur Apache (Raspberry Pi) avec certificat SSL, configuration DNS DuckDNS
                        et gestion complète de l'infrastructure.
                        </Card.Text>
                ...
                <Col md={6}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text className="text-muted">
                        Configuration serveur web sécurisé : pare-feu UFW, certificats Let's Encrypt, déploiement automatisé,
                        gestion des VirtualHosts Apache.
                        </Card.Text>
                ...
                <Col md={6}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text className="text-muted">
                        Développement d'une application web responsive avec interface utilisateur moderne, système
                        d'authentification et gestion de données.
                        </Card.Text>
                ...
                <Col md={6}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text className="text-muted">
                        Conception et mise en place d'une base de données relationnelle MariaDB avec interface de gestion
                        phpMyAdmin et requêtes optimisées.
                        </Card.Text>
