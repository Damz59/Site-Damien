...
import "./Admin_Sommaire_ReactJs.css";

export default function Admin_Sommaire_ReactJs({ authUser }) {
		...
		return (
			<main className="flex-grow-1 overflow-auto">
				...
				<Container className="my-5">
					<h1 className="mb-4">Administration — ReactJS (Sommaire)</h1>
	...
	return (
		<main className="flex-grow-1 overflow-auto">
			...
			<Container className="my-5 admin-sommaire-reactjs">
				<div className="admin-sommaire-reactjs__titlebar">
					<h1 className="mb-0">Administration — ReactJS (Sommaire)</h1>
				...
				<Card className="shadow-sm">
					<Card.Header className="admin-sommaire-reactjs__cardHeader">
					...
					<Card.Body>
						{!loading && sorted.length === 0 ? (
							...
							<div className="admin-sommaire-reactjs__tableWrap">
								<Table responsive hover className="mb-0 align-middle">
									<thead>
										<tr>
											<th className="admin-sommaire-reactjs__colOrder">Ordre</th>
											<th>Titre</th>
											<th>Slug</th>
											<th className="admin-sommaire-reactjs__colActive">Actif</th>
											<th className="admin-sommaire-reactjs__colActions text-end">
												Actions
											</th>
										</tr>
									</thead>
									...
									<tbody>
										{sorted.map((ch, idx) => (
											<tr key={ch.id ?? ch.slug}>
												<td>
													<div className="admin-sommaire-reactjs__orderBtns">
														<Button
												...
												<td>
													<code className="admin-sommaire-reactjs__code">{ch.slug}</code>
												</td>
												...
												<td className="text-end">
													<div className="admin-sommaire-reactjs__actions">
														<Button
					...
					<Modal.Body>
						...
						<Form.Group className="mb-3">
							...
							<Form.Text className="text-muted">
								Minuscules + tirets. Exemple : <code>jsx-composants</code>
							</Form.Text>
						</Form.Group>
