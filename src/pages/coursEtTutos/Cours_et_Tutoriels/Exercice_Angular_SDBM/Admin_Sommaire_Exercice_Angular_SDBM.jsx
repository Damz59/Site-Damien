	...
	return (
		<main className="flex-grow-1 overflow-auto">
			...
			<Container className="my-5 admin-sommaire-exercice-angular-sdbm">
				<div className="admin-sommaire-exercice-angular-sdbm__titlebar">
					<h1 className="mb-0">Administration — Exercice Angular SDBM (Sommaire)</h1>
					...
					<Modal.Body>
						<Form.Group className="mb-3">
							...
							<Form.Control
								...
								placeholder="Ex: Partie 1 — Composants"
								required
							/>
						</Form.Group>
						...
						<Form.Group className="mb-3">
							...
							<Form.Control
								...
								placeholder="Ex: composants"
								required
							/>
							<Form.Text className="text-muted">
								Minuscules + tirets. Exemple : <code>composants</code>
							</Form.Text>
						</Form.Group>
