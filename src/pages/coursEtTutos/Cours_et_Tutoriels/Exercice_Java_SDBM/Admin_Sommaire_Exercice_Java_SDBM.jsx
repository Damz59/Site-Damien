// src/pages/coursEtTutos/Cours_et_Tutoriels/Exercice_Java_SDBM/Admin_Sommaire_Exercice_Java_SDBM.jsx
...
import "./Admin_Sommaire_Exercice_Java_SDBM.css";

export default function Admin_Sommaire_Exercice_Java_SDBM({ authUser }) {
	// ✅ slug du cours (côté BDD/API)
	// Dans ton cas (admin du site) : Slug = "java_sdbm"
	const courseSlug = "java_sdbm";
		...
		return (
			<main className="flex-grow-1 overflow-auto">
				...
				<Container className="my-5">
					<h1 className="mb-4">Administration — Exercice Java SDBM (Sommaire)</h1>
	...
	return (
		<main className="flex-grow-1 overflow-auto">
			...
			<Container className="my-5 admin-sommaire-exercice-java-sdbm">
				<div className="admin-sommaire-exercice-java-sdbm__titlebar">
					<h1 className="mb-0">Administration — Exercice Java SDBM (Sommaire)</h1>
				...
				<Card className="shadow-sm">
					<Card.Header className="admin-sommaire-exercice-java-sdbm__cardHeader">
					...
					<Card.Body>
						{!loading && sorted.length === 0 ? (
							...
							<div className="admin-sommaire-exercice-java-sdbm__tableWrap">
								<Table responsive hover className="mb-0 align-middle">
									<thead>
										<tr>
											<th className="admin-sommaire-exercice-java-sdbm__colOrder">
												Ordre
											</th>
											<th>Titre</th>
											<th>Slug</th>
											<th className="admin-sommaire-exercice-java-sdbm__colActive">
												Actif
											</th>
											<th className="admin-sommaire-exercice-java-sdbm__colActions text-end">
												Actions
											</th>
										</tr>
									</thead>
									...
									<tbody>
										{sorted.map((ch, idx) => (
											<tr key={ch.id ?? ch.slug}>
												<td>
													<div className="admin-sommaire-exercice-java-sdbm__orderBtns">
														<Button
												...
												<td>
													<code className="admin-sommaire-exercice-java-sdbm__code">
														{ch.slug}
													</code>
												</td>
												...
												<td className="text-end">
													<div className="admin-sommaire-exercice-java-sdbm__actions">
														<Button
					...
					<Modal.Body>
						...
						<Form.Group className="mb-3">
							...
							<Form.Control
								...
								placeholder="Ex: jdbc-connexion"
								required
							/>
							<Form.Text className="text-muted">
								Minuscules + tirets. Exemple : <code>jdbc-connexion</code>
							</Form.Text>
						</Form.Group>
						...
						<Form.Check
							type="switch"
							id="active-switch-exercice-java-sdbm"
							label="Actif"
							checked={form.active}
							onChange={(e) =>
