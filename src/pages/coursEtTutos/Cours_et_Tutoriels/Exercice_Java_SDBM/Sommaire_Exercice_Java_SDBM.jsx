// Sommaire_Exercice_Java_SDBM.jsx
...
export default function Sommaire_Exercice_Java_SDBM({ authUser }) {
    ...
    useEffect(() => {
        ...
        try {
            ...
            throw new Error(data?.error || "Erreur chargement sommaire Java SDBM");
            }
    ...
    if (!authUser) {
        ...
        <main className="flex-grow-1 overflow-auto">
            ...
            <h1 className="mb-4">Exercice Java SDBM — Sommaire</h1>
    ...
    return (
        ...
        <Container className="my-5">
            ...
            <h1 className="mb-0">Exercice Java SDBM — Sommaire</h1>
            ...
            <Card.Body className="d-flex gap-2 flex-wrap">
                ...
                to="/coursEtTutos/java_sdbm"
                >
                ← Retour Exercice Java SDBM
                </Link>
            </Card.Body>
            </Card>
        </Container>
